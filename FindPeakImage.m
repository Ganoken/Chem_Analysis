...
[Peaks2,TimeStamps2] = findpeaks(filtered,'MinPeakDistance',0.01*Frequency/2);
...
PeakImageMean = mean(PeakImage,3);

FileName = ['I:\ch0618\output\peak_image_50.mat']; % output file name
save(FileName,'PeakImage'); 
FileName = ['I:\ch0618\output\peak_image_50_mean.mat']; % output file name
save(FileName,'PeakImageMean'); 